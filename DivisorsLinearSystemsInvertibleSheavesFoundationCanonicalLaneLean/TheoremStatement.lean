import HautevilleHouse.DivisorsLinearSystemsInvertibleSheavesFoundationCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "divisors-linear-systems-invertible-sheaves theorem certificate internalized through baseline gates, source constants, reviewer bridge, manifest hashes, and outside-constant dependency count",
